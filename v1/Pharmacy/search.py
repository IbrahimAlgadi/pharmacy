...
# Exports
from export_search_details_table import *
from exports_search_table import *
from import_details_search_table import *
from imports_search_table import *
from suppliers_search_table import *
from categories_search_table import *
from products_search_table import *
# Search PART
...
class Search(BoxLayout):
    ...
    def set_products_date(self, date_obj):
        ...
        self.ids.products_search_date_label.text = str(date_obj)
    ...
    def set_imports_date(self, date_obj):
        self.previous_date = date_obj
        self.ids.imports_search_date_label.text = str(date_obj)
    ...
    def set_exports_date(self, date_obj):
        self.previous_date = date_obj
        self.ids.exports_search_date_label.text = str(date_obj)
