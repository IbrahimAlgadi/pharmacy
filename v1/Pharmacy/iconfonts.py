...
class IconFonts():
    def register(self, name, ttf_fname, fontd_fname):
    ...
    def icon(self, code, size=None, color=None, font_name=None):
    ...
    def create_fontdict_file(self, css_fname, output_fname):
